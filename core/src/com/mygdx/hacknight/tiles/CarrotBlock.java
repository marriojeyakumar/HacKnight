...
public class CarrotBlock extends PhysicalObject implements InteractableObject {
    private final TiledMapTileSet tileset;

    public CarrotBlock(WorldRenderer wr, Rectangle hitbox) {
        super(wr, hitbox);
    ...
    public void hitMarioHead() {
        if (isBlankBlock())
            ...
            wr.spawnItem(new ItemDef(new Vector2(body.getPosition().x, body.getPosition().y + 16 * HacKnight.SCALE), Carrot.class));
        }
